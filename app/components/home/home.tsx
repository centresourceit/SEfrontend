        ...
        <div className="z-50 p-8 grid place-items-center">
          <div>
            <h1 className="text-white text-3xl text-center">
              We are the <span className="text-[#54edec]">B-Corp</span> for
              <br /> <span className="text-[#54edec]">Ethical </span>Tech
              Offering
            </h1>
            ...
            <div className="flex justify-evenly my-8">
              ...
              <Link
                to={"/login"}
                className="text-[#181136] bg-[#54edec] py-2 px-4 sm:py-4 sm:px-6 text-md font-medium rounded-full w-32 sm:w-40 inline-block text-center"
              >
                Login
              </Link>
            </div>
