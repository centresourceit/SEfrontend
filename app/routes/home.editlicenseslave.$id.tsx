...
export async function loader({ params, request }: LoaderArgs) {
  ...
  return json({
    users: user.data.getAllUser,
    licenses: licenses.data.getAllLicense,
    token: cookie.token,
    userId: cookie.id,
    licenseslave: data.data.getAllLicenseslaveById,
  });
}
    ...
    const LicenseSlaveScheme = z
      .object({
        ...
        paymentAmount: z
          ...
          .refine((val) => val != 0, {
            message: "Payment Amount shoud be more then 0",
          }),
        paymentStatus: z
          .string()
        ...
        licenseValidity: z.date({
          required_error: "License Validity is required",
          invalid_type_error: "License Validitys Should be a valid date",
        }),
      })
      .strict();
    ...
    <>
      <div className="grow w-full  p-4  ">
        ...
        >
          ...
          <option className=" text-white text-lg" value="ACTIVE">
            ACTIVE
          </option>
          <option className=" text-white text-lg" value="INACTIVE">
            INACTIVE
          </option>
        </select>
