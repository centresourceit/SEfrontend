...
const UserDashboard = () => {
  ...
  const deletePrinciple = async () => {
    const data = await ApiCall({
      query: `
      mutation deletePrincipleById($updatePrincipleInput:UpdatePrincipleInput!){
        deletePrincipleById(updatePrincipleInput:$updatePrincipleInput){
          name,
          id
        }
      }
            ...
            principle.map((val: any, index: number) => {
              return (
                <div key={index} className="bg-primary-800 w-80 p-4 flex flex-col">
                  ...
                  <p className="text-gray-200 font-semibold text-md mt-2">
                    {val.description}
                  </p>
                  ...
                  <div className="flex w-full gap-4 mt-2">
                    ...
                    <button
                      onClick={() => navigator(`/home/editprinciple/${val.id}`)}
