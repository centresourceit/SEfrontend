        ...
        <div className="flex">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="bg-primary-500 mt-4 py-1 text-white text-xl font-normal px-4 rounded-md text-center">Status</button>
            <button
              onClick={(e) => { setId(data.data.searchResult[0].id); setAdminComment((val: boolean) => true) }}
              className="bg-primary-500 mt-4 py-1 text-white text-xl font-normal px-4 rounded-md text-center">Comment</button>
            <Link to={"/home/adminresult/"}
