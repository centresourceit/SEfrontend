          ...
          {result == null || result == undefined ? (
            ...
            result.map((val: any, index: number) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-primary-800 p-4 w-96 flex flex-col"
                >
                  <div className="flex gap-6 items-center">
                    ...
                    <p className="text-white font-semibold text-xl">
                      ...
                      <span className="text-md">
                        [ID: {val.certificatedId}]
                      </span>
                    </p>
                    <div className="grow"></div>
                    <Link
                      to={`/home/adminresultdata/${val.id}`}
                      className="bg-primary-500 py-1 text-white text-md font-normal rounded-md text-center w-16"
                    >
                      View
                    </Link>
                  </div>
                  ...
                  <p className="text-gray-200 font-normal text-md my-1">
                    Project Per License :{" "}
                    {val.license.licenseType.projectPerLicense}
                  </p>
                  <p className="text-gray-200 font-normal text-md my-1">
                    Questions Per License :{" "}
                    {val.license.licenseType.questionAllowed}
                  </p>
                  <div className="grow"></div>
                  <div className="w-full h-[2px] bg-white my-2"></div>
                  <div className="flex gap-4">
                    <button
                      ...
                      className="bg-primary-500 mt-4 py-1 text-white text-xl font-normal flex-1 rounded-md text-center"
                    >
                      Status
                    </button>
                    <button
