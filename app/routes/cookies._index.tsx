...
const Cookies: React.FC = (): JSX.Element => {
    ...
    return (
        ...
        <div className="bg-[#181136] h-screen w-full py-14 lg:p-28 p-4 z-20">
            <h3 className="text-center text-4xl font-semibold text-white">Cookies</h3>
            ...
            <p className="text-xl font-normal text-white my-4">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque molestias porro nisi sed laudantium perferendis. Mollitia, vel. Molestiae cum neque excepturi nemo? Veniam voluptate, corporis vitae veritatis mollitia aut fuga iste natus quis tenetur nam saepe exercitationem. Quisquam incidunt eligendi excepturi dolore maiores distinctio fugit libero reprehenderit vitae quia dignissimos vero nisi cumque saepe dicta accusantium odio in eos voluptatum explicabo molestias, ullam blanditiis accusamus labore. Laudantium illo quas
            </p>
            <p className="text-xl font-normal text-white my-4">
            ...
            <button
                onClick={() => navigator(-1)}
                className="bg-cyan-500 py-1 px-4 text-white font-normal"
            >Back To Home</button>
        </div>
    );
}
