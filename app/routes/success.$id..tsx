    ...
    <div className="bg-[#eeeeee] h-screen w-full grid place-items-center">
      {license.status ? (
        <div className="w-80 bg-white rounded-md shadow-md p-6">
          ...
          <h1 className="my-4 text-green-500 bg-green-500 bg-opacity-10 rounded-md border-l-2 border-green-500 p-2">
            Payment completed Sucessfully.
          </h1>
          <Link
            to={"/home"}
            className="py-2 rounded-md shadow-md bg-green-500 text-white font-semibold px-4"
          >
            Go Back Home
          </Link>
        </div>
        ...
        <div className="w-80 bg-white rounded-md shadow-md p-6">
          ...
          <h1 className="my-4 text-rose-500 bg-rose-500 bg-opacity-10 rounded-md border-l-2 border-rose-500 p-2">
            Payment not completed Something went wrong. Try Again!
          </h1>
          <Link
            to={"/home"}
            className="py-2 rounded-md shadow-md bg-rose-500 text-white font-semibold px-4"
          >
            Go Back Home
          </Link>
        </div>
